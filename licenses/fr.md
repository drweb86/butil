...
Ce logiciel est dédié au domaine public sous CC0 1.0 Universal. Le texte ci-dessous est la traduction officielle de Creative Commons.

Les composants tiers conservent leurs licences et sont listés dans THIRD-PARTY-NOTICES.md.
...
-  Le droit de reproduire, adapter, distribuer, interpréter, représenter, communiquer et traduire une Œuvre ;
-  Les droits moraux détenus par le ou les auteur(s) originel(s) et/ou le ou les interprète(s) ;
-  Les droits à la vie privée et à l'image des personnes représentées dans une Œuvre ;
-  Le droit de la concurrence déloyale à l'égard d'une Œuvre, soumis aux limitations prévues dans le paragraphe 4(a) ci-dessous ;
-  Les droits protégeant l'extraction, la diffusion, l'utilisation et la réutilisation des données contenues dans une Œuvre ;
...
-  Tous autres droits similaires, équivalents ou correspondants à travers le monde, fondés sur toute loi ou traité en vigueur, et toute transposition nationale de ceux-ci.
...
-  Le Déclarant comprend et reconnaît que Creative Commons n'est pas partie à ce document et n'a aucun devoir ni obligation à l'égard de CC0 ou de l'utilisation de l'Œuvre.
