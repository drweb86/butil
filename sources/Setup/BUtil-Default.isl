...
Scheduler=Scheduler
Journals=Journals
PleaseInstallMsi=To install BUtil you should download and install fresh version of windows component "Microsoft Installer". Would you like the installer to open for you download page of "Microsoft Installer" ?
AlsoPleaseInstallDotNet2=Also you need to download and install windows component "Microsoft .Net 2.0 Framework" after installation of "Windows Installer". Would you like the installer to open for you download page of "Microsoft .Net 2.0 Framework" before quit ?'
PleaseInstallDotNet2=To install BUtil you should download and install windows component "Microsoft .Net 2.0 Framework". Would you like the installer to open for you download page of "Microsoft .Net 2.0 Framework" before quit ?'
