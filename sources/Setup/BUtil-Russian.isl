...
Toolkit=Инструменты
Md5_Signer=Подпись Md5
Documentation=Документация
Manual=Руководство Пользователя
Uninstall=Удаление
Core=Ядро приложения
Scheduler=Планировщик
Journals=Журналы резервного копирования
PleaseInstallMsi=Для установки BUtil Вам потребуется скачать и установить свежую версию компонента Windows "Microsoft Installer". Хотите открыть веб-страничку загрузки "Microsoft Installer" ?
AlsoPleaseInstallDotNet2=Также Вам понадобится затем скачать и установить компонент Windows "Microsoft .Net 2.0 Framework" после установки "Windows Installer". Хотите открыть веб-страничку загрузки "Microsoft .Net 2.0 Framework" перед завершением работы инсталлятора ?
PleaseInstallDotNet2=Для установки BUtil Вам понадобится скачать и установить компонент Windows "Microsoft .Net 2.0 Framework". Хотите открыть веб-страничку загрузки "Microsoft .Net 2.0 Framework" перед завершением работы инсталлятора ?
