...
internal class RemoteStateLoadTask(StorageSpecificServicesIoc services, TaskEvents events, string password) : BuTaskV2(services.CommonServices.Log, events, BUtil.Core.Localization.Resources.DataStorage_State_Get)
{
