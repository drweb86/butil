...
internal class WriteSourceFilesToStorageTask(
    ...
    TaskEvents events,
    Func<(bool versionIsNeeded, IncrementalBackupState updatedState)> getUpdatedState) : ParallelBuTask(services.CommonServices.Log, events, BUtil.Core.Localization.Resources.File_List_Saving)
{
