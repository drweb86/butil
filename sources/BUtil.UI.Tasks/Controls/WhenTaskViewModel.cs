...
public class WhenTaskViewModel : ObservableObject
{
    ...
    public bool Monday { get => _monday; set { if (value == _monday) return; _monday = value; OnPropertyChanged(nameof(Monday)); } }
    ...
    public bool Tuesday { get => _tuesday; set { if (value == _tuesday) return; _tuesday = value; OnPropertyChanged(nameof(Tuesday)); } }
    ...
    public bool Wednesday { get => _wednesday; set { if (value == _wednesday) return; _wednesday = value; OnPropertyChanged(nameof(Wednesday)); } }
    ...
    public bool Thursday { get => _thursday; set { if (value == _thursday) return; _thursday = value; OnPropertyChanged(nameof(Thursday)); } }
    ...
    public bool Friday { get => _friday; set { if (value == _friday) return; _friday = value; OnPropertyChanged(nameof(Friday)); } }
    ...
    public bool Saturday { get => _saturday; set { if (value == _saturday) return; _saturday = value; OnPropertyChanged(nameof(Saturday)); } }
