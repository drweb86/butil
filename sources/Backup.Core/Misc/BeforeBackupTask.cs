...
{
	/// <summary>
	/// The before backup task that occurs before any processing
	/// </summary>
	internal sealed class BeforeBackupTask: IJob
	{
		#region Fields
		...
		public BeforeBackupTask(ExecuteProgramTaskInfo taskInfo, ProcessPriorityClass priority, LogBase log)
		{
			...
			_taskName = Resources.BeforeBackupTask + taskInfo.ToString() + " :";
			_taskInfo = taskInfo;
			_priority = priority;
			_log = log;
		}
